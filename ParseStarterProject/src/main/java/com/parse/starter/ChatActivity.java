...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query1.whereEqualTo("recepient",ParseUser.getCurrentUser().getUsername());
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if(e==null)
                {
                    ...
                    {
                        messages.clear();
                        for(ParseObject messsage:objects)
                        {
                            String messageContent = messsage.getString("message");
                            messageContent = messsage.getString("sender") + " : " + messageContent;
